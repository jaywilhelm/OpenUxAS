...
while True:
    ...
    if msg_obj.FULL_LMCP_TYPE_NAME == 'afrl.cmasi.MissionCommand':
        # print(msg_obj.FULL_LMCP_TYPE_NAME)
        # get waypoints
        for wp in msg_obj.get_WaypointList():
    ...
    # msg_obj = get_from_uxas(socket2, factory)
    # print('\tmsg1:\t' + str(msg_obj.FULL_LMCP_TYPE_NAME) + '\t\tmsg2:\t' + str(msg_obj.FULL_LMCP_TYPE_NAME))
    if (checkMC == 1) and (msg_obj.FULL_LMCP_TYPE_NAME == 'afrl.cmasi.AirVehicleState'):
